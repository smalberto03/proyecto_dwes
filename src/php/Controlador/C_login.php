<?php
    ...
    class Controlador_login{
        ...
        public function mover_a_vista_login() //Este metodo insracianun objeto de la clase MOdelo realiza el nmetodo y observa que devuelbe y depende de eso llama a una vista o a otra
        {
